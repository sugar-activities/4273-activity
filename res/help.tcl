...
Help Quit.No {Keep Playing SimCity} \
{Press this button to continue playing this game of SimCity.}

Help Quit.IQuit {Really Quit SimCity} \
{Press this button to quit playing this game of SimCity.}

Help Quit.IResign {Resign SimCity} \
{Press this button to resign yourself from this game of SimCity.}

Help Quit.AllQuit {Everyone Quit SimCity} \
{Press this vote button to quit SimCity if everyone else agrees.}
...
Help Head {SimCity Controls Window} {}
Help Head.SimCityMenu {SimCity Main Menu} {}
...
Help Head.Date {SimCity Date Display} {}
Help Head.Funds {SimCity Funds Display} {}
...
Help Notice {SimCity Notice Window} {}
...
Help Frob {SimCity Frob-O-Matic Dynamic Zone Filter} {This bank of (min/max) interval sliders adjust the filters for the dynamic zone map view. The zones that do not pass through the filter are invisible, and the zones passing through all the filters are displayed, as you adjust the filter intervals.}
...
Help Scenario {SimCity Chooser Window} {}
...
Help Editor {SimCity Editor Window} {}
...
Help Budget {SimCity Budget Window} {}
...
Help Graph {SimCity Graph Window} {}
...
Help Evaluation {SimCity Evaluation Window} {}
...
Help Ask {SimCity Query Window} {}

# add player window

Help Player {SimCity Player Window} {}
Help Player.Players {Displays of SimCity Players} {}
Help Player.Display {Display of Player to Add} {}
Help Player.Dismiss {Dismiss Player Window Button} {}

# file window

Help File {SimCity File Chooser Window} {}
