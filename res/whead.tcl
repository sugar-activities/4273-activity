# Window: Head (global controls & menus), for Unix SimCity.
#
...
if {!(("$visual" == "pseudocolor") ||
  ...
  puts stderr "SimCity can't find an appropriate visual on display \"$display\"."
  set win ""
  return ""
}
...
wm title $win "SimCity Controls"
wm iconname $win {SimCity Controls}
...
SetHelp $win.col1.w1.f1.simcity Head.SimCityMenu

menubutton $win.col1.w1.f1.simcity\
  -menu $win.col1.w1.f1.simcity.m\
  -text {SimCity}\
  -font [Font $win Medium]\
  -variable $win.postedMenu
tk_bindForTraversal $win.col1.w1.f1.simcity
bind $win.col1.w1.f1.simcity <F10> {tk_firstMenu %W} 
bind $win.col1.w1.f1.simcity <Mod2-Key> {tk_traverseToMenu %W %A} 

tk_menus $win $win.col1.w1.f1.simcity

menu $win.col1.w1.f1.simcity.m\
  -font [Font $win Medium]
tk_bindForTraversal $win.col1.w1.f1.simcity.m
bind $win.col1.w1.f1.simcity.m <F10> {tk_firstMenu %W} 
bind $win.col1.w1.f1.simcity.m <Mod2-Key> {tk_traverseToMenu %W %A} 
  $win.col1.w1.f1.simcity.m add command\
    -label {About...}\
...
LinkWindow $win.m0 $win.col1.w1.f1.simcity.m
...
LinkWindow $win.b0 $win.col1.w1.f1.simcity
...
pack append $win.col1.w1.f1\
  $win.col1.w1.f1.simcity	{left frame nw} \
...
$win.col1.w1.f2.f1.frame.demand bind simcity <1> {TogglePause}
$win.col1.w1.f2.f1.frame.demand bind simcity <2> {TogglePause}
$win.col1.w1.f2.f1.frame.demand bind simcity <3> {TogglePause}
